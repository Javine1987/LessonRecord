...
public class MainActivity extends AppCompatActivity
    ...
    private void setupViewFragment() {
        LessonListFragment fragment = (LessonListFragment) getSupportFragmentManager().findFragmentById(R.id.fragment_container);
        if (fragment == null) {
    ...
    public static LessonViewModel obtainViewModel(FragmentActivity activity){
        ...
        return ViewModelProviders.of(activity, factory).get(LessonViewModel.class);
    }
